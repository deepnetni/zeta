...
if __name__ == "__main__":
    ...
    # B,F,T,2C
    x = torch.randn((1, 257, 251, 12))  # .cuda() # 251 = 4 second; 129 = 8 kHz; 257 = 16 kHz
    ...
    flops, parm = profile(spatialnet_small, inputs=(x,))
    ...
    # print(
    #     f"flops_forward={flops_forward_eval/1e9:.2f}G, flops_back={flops_backward_eval/1e9:.2f}G, params={params_eval/1e6:.2f} M"
    # )
