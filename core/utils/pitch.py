...
def yin(sig, config):
    ...
    return {
        ...
        "harmonic_rates": np.array(harmonic_rates),
...
def compute_pyin(
    wav, mel_len, method="pyin", normalize_mean=None, normalize_std=None, n_formants=1
):
    ...
    if method == "pyin":
        ...
        pitch_mel, voiced_flag, voiced_probs = librosa.pyin(
            snd, fmin=librosa.note_to_hz("C2"), fmax=librosa.note_to_hz("C7"), frame_length=1024
        )
