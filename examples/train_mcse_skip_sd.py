...
from models.mcse_skip_decode import aia_mcse_skip_sd
...
if __name__ == "__main__":
    ...
    cfg_fname = "config/config_mcse_skip.ini"
    ...
    # net = aia_mcse_skip_sd(in_channels=6, feature_size=257, mid_channels=60)
    ...
    #
    # net = AIA_TRANS(in_channels=6, feature_size=257, mid_channels=80) # aia_df_c80_mstft_pmsqe_B2
