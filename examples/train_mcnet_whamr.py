...
if __name__ == "__main__":
    ...
    # net = MCNetRaw(in_channels=2, ref_channel=0)
    md_conf = cfg["whamr"]["model_conf"]
    ...
    if args.train:
        cfg["config"]["info_dir"] = f'{cfg["config"]["info_dir"]}_whamr'
        train_dset, valid_dset, test_dsets = get_datasets("whamr_2chse")
