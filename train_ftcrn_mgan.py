...
from core.utils.HAids.PyFIG6.pyFIG6 import FIG6_compensation_vad, FIG6_compensation
...
class Train(EngineGAN):
    ...
    def batch_hasqi_score(self, sph, est, HL):
        ...
        hasqi_score = Parallel(n_jobs=8)(
            delayed(HASQI_v2)(o, self.fs, e, self.fs, ht)
